...
require_once (APPPATH.'libraries/phpxls/ExcelWriter/Format.php');
require_once (APPPATH.'libraries/phpxls/ExcelWriter/BIFFwriter.php');
require_once (APPPATH.'libraries/phpxls/ExcelWriter/Worksheet.php');
require_once (APPPATH.'libraries/phpxls/ExcelWriter/Parser.php');
require_once (APPPATH.'libraries/phpxls/OLE/PPS/Root.php');
require_once (APPPATH.'libraries/phpxls/OLE/PPS/File.php');
