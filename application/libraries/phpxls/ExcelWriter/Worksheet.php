...
require_once (APPPATH.'libraries/phpxls/ExcelWriter/Parser.php');
require_once (APPPATH.'libraries/phpxls/ExcelWriter/BIFFwriter.php');
...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
	...
	function getrowcol($ref){
		$refarr = str_split($ref);
		$huruf = '';
		$angka ='';
		foreach($refarr as $refelm){
			if(is_numeric($refelm)) $angka .= $refelm;
			else $huruf .= $refelm;
		}
		$huruf = strtolower($huruf);
		$hurufarr = array('a'=>0,'b'=>1,'c'=>2,'d'=>3,'e'=>4,'f'=>5,'g'=>6,'h'=>7,'i'=>8,
			'j'=>9,'k'=>10,'l'=>11,'m'=>12,'n'=>13,'o'=>14,'p'=>15,'q'=>16,'r'=>17,'s'=>18,'t'=>19,'u'=>20,
			'v'=>21,'w'=>22,'x'=>23,'y'=>24,'z'=>25,'aa'=>26,'ab'=>27,'ac'=>28,'ad'=>29,'ae'=>30,'af'=>31,'ag'=>32,'ah'=>33,'ai'=>34,
			'aj'=>35,'ak'=>36,'al'=>37,'am'=>38,'an'=>39,'ao'=>40,'ap'=>41,'aq'=>42,'ar'=>43,'as'=>44,'at'=>45,'au'=>46,
			'av'=>47,'aw'=>48,'ax'=>49,'ay'=>50,'az'=>51,'ba'=>52,'bb'=>53,'bc'=>54,'bd'=>55,'be'=>56,'bf'=>57,'bg'=>58,
                        'bh'=>59,'bi'=>60,'bj'=>61,'bk'=>62,'bl'=>63,'bm'=>64,'bn'=>65,'bo'=>66,'bp'=>67,'bq'=>68,'br'=>69,'bs'=>70,'bt'=>71,'bu'=>72,
                        'bv'=>73,'bw'=>74,'bx'=>75,'by'=>76,'bz'=>77,'ca'=>78,'cb'=>79,'cc'=>80,'cd'=>81,'ce'=>82,'cf'=>83,'cg'=>84,
                        'ch'=>85,'ci'=>86,'cj'=>87,'ck'=>88,'cl'=>89,'cm'=>90,'cn'=>91,'co'=>92,'cp'=>93,'cq'=>94,'cr'=>95,'cs'=>96,'ct'=>97,'cu'=>98,
                        'cv'=>99,'cw'=>100,'cx'=>101,'cy'=>102,'cz'=>103,'da'=>104,'db'=>105,'dc'=>106,'dd'=>107,'de'=>108,'df'=>109,'dg'=>110,
                        'dh'=>111,'di'=>112,'dj'=>113,'dk'=>114,'dl'=>115,'dm'=>116,'dn'=>117,'do'=>118,'dp'=>119,'dq'=>120,'dr'=>121,'ds'=>122,'dt'=>123,'du'=>124,
                        'dv'=>125,'dw'=>126,'dx'=>127,'dy'=>128,'dz'=>129,'ea'=>130,'eb'=>131,'ec'=>132,'ed'=>133,'ee'=>134,'ef'=>135,'eg'=>136,
                        'eh'=>137,'ei'=>138,'ej'=>139,'ek'=>140,'el'=>141,'em'=>142,'en'=>143,'eo'=>144,'ep'=>145,'eq'=>146,'er'=>147,'es'=>148,'et'=>149,'eu'=>150,
                        'ev'=>151,'ew'=>152,'ex'=>153,'ey'=>154,'ez'=>155,'fa'=>156,'fb'=>157,'fc'=>158,'fd'=>159,'fe'=>160,'ff'=>161,'fg'=>162,
                        'fh'=>163,'fi'=>164,'fj'=>165,'fk'=>166,'fl'=>167,'fm'=>168,'fn'=>169,'fo'=>170,'fp'=>171,'fq'=>172,'fr'=>173,'fs'=>174,'ft'=>175,'fu'=>176,
                        'fv'=>177,'fw'=>178,'fx'=>179,'fy'=>180,'fz'=>181,'ga'=>182,'gb'=>183,'gc'=>184,'gd'=>185,'ge'=>186,'gf'=>187,'gg'=>188,
                        'gh'=>189,'gi'=>190,'gj'=>191,'gk'=>192,'gl'=>193,'gm'=>194,'gn'=>195,'go'=>196,'gp'=>197,'gq'=>198,'gr'=>199,'gs'=>200,'gt'=>201,'gu'=>202,
                        'gv'=>203,'gw'=>204,'gx'=>205,'gy'=>206,'gz'=>207,'ha'=>208,'hb'=>209,'hc'=>210,'hd'=>211,'he'=>212,'hf'=>213,'hg'=>214,
                        'hh'=>215,'hi'=>216,'hj'=>217,'hk'=>218,'hl'=>219,'hm'=>220,'hn'=>221,'ho'=>222,'hp'=>223,'hq'=>224,'hr'=>225,'hs'=>226,'ht'=>227,'hu'=>228,
                        'hv'=>229,'hw'=>230,'hx'=>231,'hy'=>232,'hz'=>233,'ia'=>234,'ib'=>235,'ic'=>236,'id'=>237,'ie'=>238,'if'=>239,'ig'=>240,
                        'ih'=>241,'ii'=>242,'ij'=>243,'ik'=>244,'il'=>245,'im'=>246,'in'=>247,'io'=>248,'ip'=>249,'iq'=>250,'ir'=>251,'is'=>252,'it'=>253,'iu'=>254,
                        'iv'=>255);

		$retval[0] =$angka-1;//row
		$retval[1] = $hurufarr[$huruf];//col
		return $retval;
	}

    function writeref($ref, $token, $format = null){
		$arr = $this->getrowcol($ref);
		$this->write($arr[0], $arr[1], $token, $format);
    }
    ...
    */
	...
	function mergeCellsReff($first_ref, $last_ref, $token, $format=null ){		
		$f = $this->getrowcol($first_ref);
		$l = $this->getrowcol($last_ref);
		$frow = $f[0];
		$fcol = $f[1];
		$lrow = $l[0];
		$lcol = $l[1];
		for($n=$frow; $n<=$lrow; $n++){
			for($i=$fcol;$i<=$lcol;$i++){
				$this->write($n,$i,'',$format);
			}
		}
		$this->write($frow,$fcol,$token, $format);
		$this->mergeCells($frow, $fcol, $lrow, $lcol);
	}
    /**
