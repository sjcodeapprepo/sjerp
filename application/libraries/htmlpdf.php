...
function __construct($orientation='L',$unit='mm',$format='A4')
{
    ...
    $this->fontlist=array("arial","times","courier","helvetica","symbol","monaco","inconsolata","monofur");
    $this->issetfont=false;
    $this->issetcolor=false;
	$this->NamaPT = $this->_getCompanyName();
}
...
function OpenTag($tag,$attr)
{
    ...
    switch($tag){
        ...
        case 'TR': //TR-BEGIN
            break;
        case 'TD': // TD-BEGIN
			$this->tdwidth=15; // SET to your own width if you need bigger fixed cells
            if(isset($attr['WIDTH'])){
				if($attr['WIDTH']!= '') $this->tdwidth=($attr['WIDTH']/4);
			}
            $this->tdheight=4; // SET to your own height if you need bigger fixed cells
			if(isset($attr['HEIGHT'])) $this->tdheight=$attr['HEIGHT'];
