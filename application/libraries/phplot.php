...
class PHPlot {
    ...
    public $is_inline = FALSE;//FALSE;//TRUE;             // FALSE = Sends headers, TRUE = sends just raw image data
    public $browser_cache = TRUE;//TRUE;//FALSE;         // FALSE = Sends headers for browser to not cache the image,
...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    public $shading = 2;                       // 0 for no shading, > 0 is size of shadows in pixels
...
//////////////////////////////////////////////////////////
    ...
    function FindDataLimits()
    {
        ...
        $process_stacked = ($this->plot_type == 'stackedbars' || $this->plot_type == 'stackedarea' || $this->plot_type == 'bars');
