...
<head>
    <title>Data Sertififkat/Ijasah Karyawan - input</title>
...
$('#idkaryawan').select2({
		ajax: {
			delay: 200,
			url: '<?=site_url()?>/hr/sertkarytrns/getKaryawanMst/',
			dataType: 'json',
			type: "POST",
                ...
                <td>
                    <table class='gridtable' width='400'>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="idkaryawan" id="idkaryawan" class="fixwidthlebar" data-placeholder="-- pilih Nama atau NIK Karyawan Aktif --"/></select>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
