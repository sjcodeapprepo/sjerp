...
<head>
    <title>Master Kategori Peralatan dan Perlengkapan</title>
...
<body>
    ...
    <br />
    <br />
    <form action="<?= site_url() ?>/sjaset/asetkategorilenglatmaster/index" method='post' id='formin' enctype="multipart/form-data">
    <table align="center">
    <tr><td>
    ...
    <thead>
        <tr>
            <th>KATEGORI PERLENGKAPAN DAN PERLATAN</th>
        </tr>
    </thead>
    </table>
