...
<head>
    <title>Master Kategori Gedung dan Bangunan</title>
...
<body>
    ...
    <br />
    <br />
    <form action="<?= site_url() ?>/sjaset/asetkategorigdbangmaster/index" method='post' id='formin' enctype="multipart/form-data">
    <table align="center">
    <tr><td>
    ...
    <thead>
        <tr>
            <th>KATEGORI GEDUNG DAN BANGUNAN</th>
        </tr>
    </thead>
    </table>
